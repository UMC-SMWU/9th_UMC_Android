...
import com.example.week6.databinding.FragmentStorageSongBinding
...
class StorageSongFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val storageSongAdapter = StorageSongRVAdapter(storageSongList)
        binding.storageSongRv.adapter = storageSongAdapter
        binding.storageSongRv.layoutManager = LinearLayoutManager(context,
            LinearLayoutManager.VERTICAL, false)


        storageSongAdapter.setMyItemClickListener(object : StorageSongRVAdapter.MyItemClickListener {
