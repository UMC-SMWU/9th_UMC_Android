...
import com.example.week5.AlbumFragment
import com.example.week5.AlbumRVAdapter
import com.example.week5.BannerFragment
import com.example.week5.BannerVPAdapter
import com.example.week5.HomeBannerFragment
import com.example.week5.HomeBannerVPAdapter
...
//            val albumFragment = AlbumFragment()
        ...
        albumRVAdapter.setMyItemClickListener(object: AlbumRVAdapter.MyItemClickListener{
            ...
            override fun applyItemToSeekBar(album: Album) {
                (activity as Week5).setPlayerData(album) // 이 부분도 requireActivity()방식으로 작성하면 null안정성이 있다고는 하는데, 정확히 어떻게 안정성이 있는지 궁금해서 질문드립니다!
