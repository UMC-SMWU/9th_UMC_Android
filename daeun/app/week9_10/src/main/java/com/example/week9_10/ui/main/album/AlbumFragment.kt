...
import com.example.week9_10.databinding.FragmentAlbumBinding
...
class AlbumFragment: Fragment() {
    ...
    private fun setInit(album: Album){
        album.coverImg?.let { binding.albumAlbumIv.setImageResource(it) }
    ...
    private fun setOnClickedListeners(album: Album){
        val userId = getJwt()
